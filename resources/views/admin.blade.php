                        ...
                        <form action="{{ route('video.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mt-3 mt-md-0">
                                    <input type="text" class="form-control" name="title" id="email" placeholder="Title" required>
                                </div>
                            </div>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" name="artis" id="subject" placeholder="Artis" required>
                            </div>
                            <div class="form-group mt-3">
                                <input type="file" class="form-control" name="video_music" accept="video/*" required>
                                <video id="preview-video" width="640" height="360" controls style="display: none;"></video>
                            </div>

                            <script>
                                const fileInput = document.querySelector('input[name="video_music"]');
